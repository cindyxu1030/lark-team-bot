...
grep FEISHU_APP_ID "/Users/YOURNAME/lark-team-bot/.env"
```
...
launchctl unload ~/Library/LaunchAgents/com.YOURNAME.lark-claude.plist
launchctl load ~/Library/LaunchAgents/com.YOURNAME.lark-claude.plist

# 快速踢一脚（没改配置、只是进程卡住了）
launchctl kickstart -k gui/$(id -u)/com.YOURNAME.lark-claude

# 看日志
tail -f "/Users/YOURNAME/lark-team-bot/stdout.log"
```
